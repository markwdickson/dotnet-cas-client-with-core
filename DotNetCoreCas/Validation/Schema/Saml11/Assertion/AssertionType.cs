...
using DotNetCoreCas.Validation.Schema.Saml11.Assertion.Statement;
using DotNetCoreCas.Validation.Schema.Saml11.Assertion.SubjectStatement;
using DotNetCoreCas.Validation.Schema.XmlDsig;

namespace DotNetCoreCas.Validation.Schema.Saml11.Assertion
{
    [Serializable]
    [DebuggerStepThrough]
