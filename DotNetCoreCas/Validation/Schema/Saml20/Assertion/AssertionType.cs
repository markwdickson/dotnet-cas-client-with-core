...
using DotNetCoreCas.Validation.Schema.Saml20.Assertion.Condition;
using DotNetCoreCas.Validation.Schema.Saml20.Assertion.Statement;
using DotNetCoreCas.Validation.Schema.XmlDsig;

namespace DotNetCoreCas.Validation.Schema.Saml20.Assertion
{
    [Serializable]
    [DebuggerStepThrough]
