...
namespace DotNetCoreCas.Validation.TicketValidator
{
    ...
    class Saml11TicketValidator : AbstractUrlTicketValidator
    {
        ...
        /// </summary>
        public override void Initialize(Microsoft.AspNetCore.Http.HttpContext context = null, ICasOptions options = null)
        {
            // Do nothing
        }
        ...
        protected override ICasPrincipal ParseResponseFromServer(string response, string ticket, ICasOptions options)
        {
            ...
            CasSaml11Response casSaml11Response = new CasSaml11Response(response, options.TicketTimeTolerance);
