...
namespace DotNetCoreCas.Validation.TicketValidator
{
    ...
    public abstract class AbstractUrlTicketValidator : ITicketValidator
    {
        ...
        /// </summary>
        public abstract void Initialize(Microsoft.AspNetCore.Http.HttpContext context, ICasOptions options);
        ...
        /// </exception>
        protected abstract ICasPrincipal ParseResponseFromServer(string response, string ticket, ICasOptions options);
        #endregion
        ...
        /// </exception>
        public ICasPrincipal Validate(Microsoft.AspNetCore.Http.HttpContext context, string ticket, ICasOptions options)
        {
            string validationUrl = UrlUtil.ConstructValidateUrl(context, ticket, false, false, CustomParameters, options);
            ...
            protoLogger.Debug($"Ticket validation response:{Environment.NewLine}{serverResponse}");

            return ParseResponseFromServer(serverResponse, ticket, options);
        }
        #endregion
    }
}